...
import webrtcvad
import time
from wearable.utils import list_devices, list_supported_sample_rates
...
def test_vad_directly(device_index: int = 20):
    ...
    try:
        ...
        print(f"\n\nTest completed!")
        print(
            f"Speech detected in {speech_frames}/{total_frames} frames ({speech_frames/total_frames*100:.1f}%)"
        )
